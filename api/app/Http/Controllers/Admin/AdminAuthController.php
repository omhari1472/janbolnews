...
class AdminAuthController extends Controller {
    ...
    public function login(Request $request) {
        ...
        return $this->successResponse(['access_token'=>$token,'token_type'=>'Bearer','user'=>['id'=>$user->id,'name'=>$user->name,'email'=>$user->email,'role'=>$user->role,'permissions'=>$user->permissions,'avatar_url'=>$user->avatar_url]],'Login successful');
    }
